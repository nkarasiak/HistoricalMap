    ...
    def __init__(self,inImage,outName,inShapeGrey,inShapeMedian,iterMedian):
        ...
        for i in range(d):
            ...
            try:
                ...
                print("Problem reading band "+str(i)+" from image "+inImage)
            ...
            try:
                ...
                print("Problem with Grey Closing")
            ...
            for j in range(iterMedian):
                try:
                    ...
                    print("Problem with median filter")
            ...
            try:
                ...
                print("Cannot save band"+str(i)+" on image" + outName)
...
class learnModel():
    ...
    def __init__(self,inRaster,inVector,inField='Class',inSplit=0.5,inSeed=0,outModel=None,outMatrix=None,inClassifier='GMM'):
        ...
        try:
            ...
            print("Problem with making tempfile or opening raster or vector")
        ...
        try:
            ...
            print("Cannot create temporary data set")
        
        # Load Training set
        try:
            X,Y =  dataraster.get_samples_from_roi(inRaster,filename)
        except:
            print("Problem while getting samples from ROI with"+inRaster)
        ...
        try:
            ...
            print("Problem while learning if SPLIT <1")
        ...
        if SPLIT < 1 :
            ...
            self.OA = round(CONF.OA*100,2)
            self.Kappa = round(CONF.Kappa,2)
            print("OA : "+str(round(CONF.OA*100,2)))
            print("Kappa : "+str(round(CONF.Kappa,2)))
...
class classifyImage():
    ...
    def initPredict(self,inRaster,inModel):
        ...
        try:
            ...
            if model is None:
                ...
                print("Model : "+inModel+" is none")
            else:
                tree,M,m = pickle.load(model)
                model.close()
        except:
            print("Error while loading the model : "+inModel)
        ...
        try:
            ...
            print("Cannot create temp file "+rasterTemp)
            # Process the data
        try:
            predictedImage=self.predict_image(inRaster,rasterTemp,tree,None,-10000,SCALE=[M,m])
            
        except:
            print("Problem while predicting "+inRaster+" in temp"+rasterTemp)
    ...
    def postClassVector(self,inRaster,sieveSize,inClassNumber,outShp):
        ...
        try:
            ...
            print("Cannot vectorize "+inRaster)
        ...
        try:        
            ...
            print("Cannot add area and remove it if size under"+str(sieveSize))
    ...
    def postClassRaster(self,inRaster,sieveSize,inClassNumber,outShp):        
        ...
        try:
            ...
            print("Cannot sieve with raster function")
